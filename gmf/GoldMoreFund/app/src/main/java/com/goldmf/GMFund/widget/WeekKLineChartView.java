 ...
 */
public class WeekKLineChartView extends KLineBaseView {


    public WeekKLineChartView(Context context) {
        this(context, null);
    }

    public WeekKLineChartView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeekKLineChartView(Context context, AttributeSet attrs, int defStyleAttr) {

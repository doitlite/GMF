 ...
 */
public class FiveDayDetailChartRender extends KLineChartBaseRender {
    ...
    @Override
    public void drawXAxis(List<ChartController.ChartInfo> currentPageData, List<ChartInfo> previousPageData, List<ChartController.ChartInfo> nextPageData, Canvas canvas) {

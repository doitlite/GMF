 ...
 */
public class DayKLineChartRender extends KLineChartBaseRender {
    ...
    @Override
    public void drawXAxis(List<ChartController.ChartInfo> currentPageData, List<ChartController.ChartInfo> previousPageData, List<ChartInfo> nextPageData, Canvas canvas) {
        ...
        List<ChartController.ChartInfo> subPreChartInfo;
        ...
        List<ChartController.ChartInfo> subNextChartInfo;

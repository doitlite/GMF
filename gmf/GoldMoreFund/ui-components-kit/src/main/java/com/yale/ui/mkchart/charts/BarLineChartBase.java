...
import com.yale.ui.mkchart.components.YAxis.AxisDependency;
...
import com.yale.ui.mkchart.data.BarLineScatterCandleDataSet;
import com.yale.ui.mkchart.data.Entry;
import com.yale.ui.mkchart.data.LineData;
import com.yale.ui.mkchart.data.LineDataSet;
import com.yale.ui.mkchart.data.filter.Approximator;
import com.yale.ui.mkchart.highlight.ChartHighlighter;
import com.yale.ui.mkchart.highlight.Highlight;
import com.yale.ui.mkchart.interfaces.BarLineScatterCandleBubbleDataProvider;
import com.yale.ui.mkchart.jobs.MoveViewJob;
import com.yale.ui.mkchart.listener.BarLineChartTouchListener;
import com.yale.ui.mkchart.listener.OnDrawListener;
import com.yale.ui.mkchart.renderer.XAxisRenderer;
import com.yale.ui.mkchart.renderer.YAxisRenderer;
import com.yale.ui.mkchart.utils.FillFormatter;
import com.yale.ui.mkchart.utils.PointD;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleData<? extends BarLineScatterCandleDataSet<? extends Entry>>>
    ...
    protected void drawGridBackground(Canvas c) {
        ...
        if (mDrawBorders) {
            final RectF contentRect = mViewPortHandler.getContentRect();
            c.drawLine(contentRect.left, contentRect.top, contentRect.left, contentRect.bottom, mBorderPaint);
            c.drawLine(contentRect.left, contentRect.bottom, contentRect.right, contentRect.bottom, mBorderPaint);
            c.drawLine(contentRect.right, contentRect.top, contentRect.right, contentRect.bottom, mBorderPaint);
